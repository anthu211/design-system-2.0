...
Topbar (52px, #131313): PAI logo <img src="https://anthu211.github.io/design-system-2.0/icons/pai-logo.svg" style="height:26px"> → spacer → Last Updated → bell → avatar → Navigator t-special button. NEVER "Prevalent AI" text.
