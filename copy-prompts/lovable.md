# Prevalent AI Design System — Lovable Prompt

Paste at the start of your Lovable project prompt, before describing what to build.
...
2. https://design-system-2-0.pages.dev/page-spec.txt
3. https://design-system-2-0.pages.dev/charts.txt
