...
Topbar (52px, #131313): PAI logo <img src="https://ux-prevalent.netlify.app/icons/pai-logo.svg" style="height:26px"> → spacer → Last Updated → bell → avatar → Navigator t-special button. NEVER "Prevalent AI" text.
