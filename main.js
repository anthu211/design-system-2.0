...
function downloadClaudeMd() {
  ...
  fetch('https://ux-prevalent.netlify.app/CLAUDE.md')
    .then(function(r) {
    ...
    .catch(function() {
      showToast('error', 'Download failed — try right-clicking and saving from: ux-prevalent.netlify.app/CLAUDE.md');
    });
}
...
function downloadClaudeSetup() {
  ...
  fetch('https://ux-prevalent.netlify.app/claude-setup.zip')
    .then(function(r) {
      if (!r.ok) throw new Error('fetch failed');
      return r.blob();
    })
    ...
    .catch(function() {
      showToast('error', 'Download failed — try again or get it from: ux-prevalent.netlify.app/claude-setup.zip');
...
function copyAiPrompt() {
  var prompt = [
    ...
    'https://ux-prevalent.netlify.app/page-spec.txt',
    'https://ux-prevalent.netlify.app/charts.txt',
    '',
