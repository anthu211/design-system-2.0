...
function copyAiPrompt() {
  var prompt = [
    ...
    '',
    'The spec is the complete standard for all UI at Prevalent AI — every token, component',
    'HTML pattern, typography scale, status color, and layout rule.',
    'The UX context tells you who uses this product (Security Analyst, CISO, IT Admin),',
    'what they need, and the UX laws (Hick\'s, Fitts\'s, Miller\'s) that govern every decision.',
    'Read both fully before writing a single line of HTML.',
    '',
    ...
    '</html>',
    '',
    'Rules after reading both files:',
    '- Use EXACT colors from the spec — do not substitute or invent colors.',
    ...
    '- Tell me which persona this is for (analyst / ciso / it-admin) and apply their',
    '  goals and frustrations from the UX context to shape the layout and component choices.',
    '',
    '---',
