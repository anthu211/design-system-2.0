...
function copyAiPrompt() {
  var prompt = [
    ...
    '',
    'Fetch ALL before writing any code:',
    ...
    '',
    'HARD RULES:',
    '- KPI cards: <div class="ds-kpi-card"> only, no style="", no colored borders, no custom bg',
    '- Buttons: t-primary/t-outline/t-secondary/t-tertiary/t-danger/t-special only, border-radius:44px always',
    '- Badges: ds-badge success/warning/danger/info/neutral only, no inline colors',
    '- Tables: ds-table-wrap + ds-th + ds-td, checkbox col first, pagination footer, max 7 cols',
    '- Cards: border-radius:4px only, no box-shadow, no gradients',
    '- Charts: copy buildLineChart/buildMultiLineChart/buildVerticalBarChart from charts.md verbatim, never <canvas>',
    '- Spacing: 4,8,12,16,20,24,32,48px only',
    '- Hover: :hover required on every interactive element (buttons, tabs, nav, pagination, table actions, chips)',
    '- Nav header: always "Prevalent AI" / "Exposure Management" — NEVER change this, only nav items change per page',
    '- No extra headings, decorative sections, or illustration placeholders',
    '',
