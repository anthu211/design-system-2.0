...
function downloadClaudeSetup() {
  ...
  fetch('https://design-system-2-0.pages.dev/claude-setup.zip')
    .then(function(r) {
      if (!r.ok) throw new Error('fetch failed');
      return r.blob();
    })
    ...
    .catch(function() {
      showToast('error', 'Download failed — try again or get it from: design-system-2-0.pages.dev/claude-setup.zip');
