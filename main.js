...
function copyReactPrompt() {
  var prompt = [
    'Before generating any UI, fetch and read ALL of these files in full:',
    '',
    '1. Design tokens + rules: https://anthu211.github.io/design-system-2.0/spec.md',
    '2. React component reference: https://anthu211.github.io/design-system-2.0/react.md',
    ...
    '- Tell me which persona (ciso / grc / security-architect / security-engineer / soc-analyst) and apply their goals from the UX context.',
    '',
    '---',
