...
function copyAiPrompt() {
  var prompt = [
    'Build UI for Prevalent AI — a B2B cybersecurity exposure management platform for enterprise security teams.',
    '',
    'Fetch ALL of these files before writing any code:',
    '1. https://anthu211.github.io/design-system-2.0/spec.md        — design tokens + non-negotiable rules',
    '2. https://anthu211.github.io/design-system-2.0/shell.md       — mandatory page shell (copy verbatim)',
    '3. https://anthu211.github.io/design-system-2.0/components.md  — UI component patterns',
    '4. https://anthu211.github.io/design-system-2.0/charts.md      — SVG chart patterns',
    '5. https://anthu211.github.io/design-system-2.0/ux-context.md  — personas + UX laws',
    '',
    'Persona: [ciso / grc / security-architect / security-engineer / soc-analyst]',
    'Output: complete, self-contained HTML file using the shell and rules from the spec.',
    '',
    '── HARD NEGATIVE RULES — never do any of these ──',
    '',
    'KPI cards: NEVER add border-top/border-left colored borders or custom backgrounds.',
    '  Use ONLY <div class="ds-kpi-card"> with no style="" attribute.',
    '  Content = value + label + trend delta only.',
    '',
    'Buttons: NEVER use custom colors or border-radius other than 44px.',
    '  Use t-primary / t-outline / t-secondary / t-tertiary / t-danger / t-special classes only.',
    '',
    'Badges: NEVER use inline color overrides. Use ds-badge success/warning/danger/info/neutral only.',
    '',
    'Tables: ALWAYS wrap in ds-table-wrap. Use ds-th + ds-td classes.',
    '  Always include checkbox column (leftmost) and pagination footer. Max 7 columns default.',
    '',
    'Cards: border-radius 4px ONLY. No box-shadow. No gradient backgrounds.',
    '',
    'Callouts: ONLY ds-callout ds-callout-warning/error/info/success. Never custom styled banners.',
    '',
    'Charts: ALWAYS copy buildLineChart / buildMultiLineChart / buildVerticalBarChart from charts.md.',
    '  NEVER use <canvas>, Chart.js, D3, or write chart logic from scratch.',
    '',
    'Spacing: 4px scale only — 4,8,12,16,20,24,32,48px. Never 3,5,7,10,11,14,15px.',
    '',
